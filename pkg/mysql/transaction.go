...
// transactionManager is the concrete implementation of TransactionManager
// backed by a *sql.DB connection.
type transactionManager struct {
	db *sql.DB
}

// NewTransactionManager creates a new transaction manager with the provided DB connection.
...
// WithTransaction wraps a function inside a database transaction,
// handling commit and rollback automatically.
